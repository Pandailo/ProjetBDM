...
DROP INDEX PBDM_indexSA;
DROP INDEX PBDM_indexSR;
...
CREATE INDEX PBDM_indexSA ON PBDM_Acteur(synopsis) INDEXTYPE IS CTXSYS.CONTEXT;
CREATE INDEX PBDM_indexSR ON PBDM_Realisateur(synopsis) INDEXTYPE IS CTXSYS.CONTEXT;
